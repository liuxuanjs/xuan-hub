---
aliases: ["代码分割", "Code Splitting", "按需加载", "懒加载"]
title: "代码分割与按需加载"
tags: ["JavaScript", "性能优化", "Webpack", "Vite", "前端工程化"]
updated: 2026-01-09
---

## 概述

代码分割（Code Splitting）是将大的 JavaScript 文件拆分成多个小文件的技术，实现按需加载，减少首屏加载时间。

## 核心价值

| 优化类型 | 效果 |
|----------|------|
| **性能优化** | 减少首屏加载时间，避免下载无用代码 |
| **缓存优化** | 第三方库独立缓存，业务更新不影响 |
| **用户体验** | 按需加载，响应更快 |
