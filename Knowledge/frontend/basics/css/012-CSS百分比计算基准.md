---
aliases: ["CSS百分比", "百分比计算基准"]
title: "CSS 百分比计算基准"
tags: ["CSS", "百分比", "布局", "前端面试"]
updated: 2026-01-10
---

## 概述

CSS百分比是相对单位，遵循一个简单公式：**最终值 = 基准值 × 百分比**。关键是理解：**不同属性有不同的计算基准！**
...
- [MDN - CSS 百分比值](https://developer.mozilla.org/zh-CN/docs/Web/CSS/percentage)
- [CSS 包含块](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Containing_block)